#program to predict stock market price
#properly place the csv file in the same location
#Do not use any other csv file, as the prgoram has not been desined to handle ##data.
import csv
import numpy as np
...
get_data('ds.csv') # calling get_data method by passing the csv file to it
print(dates)
print(prices)
print("\n")
...
print("The stock open price for 27th Feb is: $",str(predicted_price))
